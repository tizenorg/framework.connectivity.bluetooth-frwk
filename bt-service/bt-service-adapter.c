		...
		bluetooth_device_info_t *dev_info)
{
	...
	if (hash != NULL) {
		...
		connected = value ? g_value_get_uchar(value) : BLUETOOTH_CONNECTED_LINK_NONE;
...
#if defined(TIZEN_TELEPHONY_ENABLED) || !defined(TIZEN_WEARABLE)
