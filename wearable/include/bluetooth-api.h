...
#define BLUETOOTH_ADVERTISE_DATA_LENGTH_MAX       31 /**< This specifies maximum AD data length */
 ...
 */
typedef struct {
	guint8 data[BLUETOOTH_ADVERTISE_DATA_LENGTH_MAX - 3];	// Except Flags
...
/**
 * @fn int bluetooth_add_white_list(bluetooth_device_address_t *address)
 ...
 */
int bluetooth_add_white_list(bluetooth_device_address_t *address);

/**
 * @fn int bluetooth_remove_white_list(bluetooth_device_address_t *address)
 ...
 * @see         bluetooth_set_custom_advertising
 */
int bluetooth_remove_white_list(bluetooth_device_address_t *address);
