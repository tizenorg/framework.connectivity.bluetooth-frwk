...
typedef enum {
	...
	BLUETOOTH_EVENT_GATT_SERVER_ON_WRITE_CHAR, /**<Gatt Char write callback event */
...
/* @fn int bluetooth_gatt_add_characteristics(const  char *char_uuid,
...
* @param[in]   value_length 	Length of GATT characteristic value.
* @param[in]   char_flags	GATT characteristic flags.
* @param[in]   flags_length	Length of GATT characteristic flags.
...
*/
int bluetooth_gatt_add_characteristics(const  char *char_uuid,
			const char *char_value, int value_length,
			const char *char_flags[], int flags_length,
			const char *svc_path, char **char_path);
...
*/
int bluetooth_gatt_add_descriptor(const char *desc_uuid,
			const char *desc_value, int value_length,
			const char *permissions, const char *char_path,
			char **desc_path);
...
/* @fn int bluetooth_gatt_remove_service(const  char *svc_path)
*
...
*/
int bluetooth_gatt_remove_service(const char *svc_path);
...
* @see	bluetooth_gatt_add_descriptor()
* @see bluetooth_gatt_register_service()
* @see bluetooth_gatt_remove_service()
*/
